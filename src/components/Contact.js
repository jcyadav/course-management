    ...
    <div>
      <div className="container my-24 px-6 mx-auto">
        ...
        <section className="mb-32 text-gray-800">
          <div className="relative overflow-hidden bg-no-repeat bg-cover" style={{backgroundPosition: '50%', backgroundImage: 'url("https://mdbootstrap.com/img/new/textures/full/284.jpg")', height: '300px'}}>
          </div>
                  ...
                  <div className="flex flex-wrap">
                    ...
                    <div className="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                      <div className="flex items-start">
                        ...
                        <div className="grow ml-6">
                          <p className="font-bold mb-1">Course questions</p>
                          <p className="text-gray-500">course@example.com</p>
                          <p className="text-gray-500">+1 234-567-89</p>
                        </div>
                      </div>
                    </div>
                    <div className="mb-12 md:mb-0 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                      <div className="flex align-start">
                        ...
                        <div className="grow ml-6">
                          ...
                          <p className="text-gray-500">xyz@example.com</p>
                          <p className="text-gray-500">+1 234-567-89</p>
                        </div>
                      </div>
                    </div>
                    <div className="grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                      <div className="flex align-start">
                        ...
                        <div className="grow ml-6">
                          <p className="font-bold mb-1">Course report</p>
                          <p className="text-gray-500">course@example.com</p>
                          <p className="text-gray-500">+1 234-567-89</p>
                        </div>
                      </div>
